...
namespace CurtSheller\Repository\Eloquent;
...
use CurtSheller\Repository\Contracts\CriteriaInterface;
use CurtSheller\Repository\Contracts\Presentable;
use CurtSheller\Repository\Contracts\PresenterInterface;
use CurtSheller\Repository\Contracts\RepositoryCriteriaInterface;
use CurtSheller\Repository\Contracts\RepositoryInterface;
use CurtSheller\Repository\Events\RepositoryEntityCreated;
use CurtSheller\Repository\Events\RepositoryEntityCreating;
use CurtSheller\Repository\Events\RepositoryEntityDeleted;
use CurtSheller\Repository\Events\RepositoryEntityDeleting;
use CurtSheller\Repository\Events\RepositoryEntityUpdated;
use CurtSheller\Repository\Events\RepositoryEntityUpdating;
use CurtSheller\Repository\Exceptions\RepositoryException;
use CurtSheller\Repository\Traits\ComparesVersionsTrait;
use CurtSheller\Validator\Contracts\ValidatorInterface;
use CurtSheller\Validator\Exceptions\ValidatorException;

/**
 * Class BaseRepository
 *
 * @package CurtSheller\Repository\Eloquent
...
abstract class BaseRepository implements RepositoryInterface, RepositoryCriteriaInterface
{
    ...
    /**
     * Specify Validator class name of CurtSheller\Validator\Contracts\ValidatorInterface
     *
     * @return null
     * @throws Exception
     */
    public function validator()
    {
        if (isset($this->rules) && !is_null($this->rules) && is_array($this->rules) && !empty($this->rules)) {
            if (class_exists('CurtSheller\Validator\LaravelValidator')) {
                $validator = app('CurtSheller\Validator\LaravelValidator');
    ...
    public function makePresenter($presenter = null)
    {
        ...
        if (!is_null($presenter)) {
            ...
            if (!$this->presenter instanceof PresenterInterface) {
                throw new RepositoryException("Class {$presenter} must be an instance of CurtSheller\\Repository\\Contracts\\PresenterInterface");
            }
    ...
    public function makeValidator($validator = null)
    {
        ...
        if (!is_null($validator)) {
            ...
            if (!$this->validator instanceof ValidatorInterface) {
                throw new RepositoryException("Class {$validator} must be an instance of CurtSheller\\Validator\\Contracts\\ValidatorInterface");
            }
     ...
     *
     * @return $this
     * @throws \CurtSheller\Repository\Exceptions\RepositoryException
     */
    public function pushCriteria($criteria)
    {
        ...
        if (!$criteria instanceof CriteriaInterface) {
            throw new RepositoryException("Class " . get_class($criteria) . " must be an instance of CurtSheller\\Repository\\Contracts\\CriteriaInterface");
        }
